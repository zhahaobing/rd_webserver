    ...
    <div class="wrapper">
        ...
        <header class="main-header">
            ...
            <nav class="navbar navbar-static-top">
                ...
                </a><span class="index_top"><strong>南京陇源汇能电力科技有限公司</strong></span>
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown user user-menu">
                            ...
                            <ul class="dropdown-menu pull-right">
                                ...
                                <li class="divider"></li>
                                <li><a href="logout.php"><i class="ace-icon fa fa-power-off"></i>安全退出</a></li>
                            </ul>
                        </li>
                    </ul>
                </div>
        ...
        <!--中间内容-->
        <!-- added by zhahaobing 2019.08.27 注释掉这些没用的菜单 start+++ -->
        <div id="content-wrapper" class="content-wrapper">
            <div class="content-tabs">
                ...
                <nav class="page-tabs menuTabs">
                    <div class="page-tabs-content" style="margin-left: 0px;">
                        <a href="javascript:;" class="menuTab active" data-id="repository.php">服务器仓库列表</a>
            ...
            <div class="content-iframe" style="overflow: hidden;">
                <div class="mainContent" id="content-main" style="margin: 10px; margin-bottom: 0px; padding: 0;">
                    <iframe class="LRADMS_iframe" width="100%" height="100%" src="repository.php" frameborder="0" data-id="repository.php"></iframe>
                </div>
            </div>
        </div>
        <!-- added by zhahaobing 2019.08.27 注释掉这些没用的菜单 end+++ -->
    </div>
